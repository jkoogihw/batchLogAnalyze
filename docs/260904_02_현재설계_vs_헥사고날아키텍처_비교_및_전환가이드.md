...
flowchart LR
    ...
    subgraph Hexagon ["Core Domain & Application (비즈니스 핵심)"]
        InboundPort["&laquo;Inbound Port&raquo;<br/>AnalyzeBatchLogUseCase"]
        ...
        OutboundPort_Policy["&laquo;Outbound Port&raquo;<br/>LoadPolicyPort"]
        OutboundPort_Log["&laquo;Outbound Port&raquo;<br/>LoadLogFilePort"]
        OutboundPort_Report["&laquo;Outbound Port&raquo;<br/>SaveReportPort"]
    end
    ...
    Service_Core --> DomainEntities
    Service_Core --> DomainServices
    Service_Core --> OutboundPort_Policy
    Service_Core --> OutboundPort_Log
    Service_Core --> OutboundPort_Report
    
    JsonPolicy_Adapter -.->|implements| OutboundPort_Policy
    DbPolicy_Adapter -.->|implements| OutboundPort_Policy
    FileLog_Adapter -.->|implements| OutboundPort_Log
    S3Log_Adapter -.->|implements| OutboundPort_Log
    MdReport_Adapter -.->|implements| OutboundPort_Report
    SlackReport_Adapter -.->|implements| OutboundPort_Report
```
